...
const Latest = () => {
  ...
  return (
    <>
      <Header />
      <div onClick={MenRedirect} className="change-cursor video-container w-[97.5%] max-w-[1600px] h-[80vh] overflow-hidden relative items-center justify-center flex m-5" data-cursor-color="#321e12">
      <div className="absolute top-1 left-5 z-10 text-[var(--color-dark-brown)]">
      <h1 className="mensHeader text-[50px] ">Men's Drop</h1>
      ...
      <div onClick={WomenRedirect} className="change-cursor video-container w-[97.5%] max-w-[1600px] h-[80vh] overflow-hidden relative items-center justify-center flex m-5" data-cursor-color="#321e12">
      <div className="absolute top-1 right-5 z-10 text-[var(--color-dark-brown)]">
      <h1 className="mensHeader text-[50px] ">Women's Drop</h1>
