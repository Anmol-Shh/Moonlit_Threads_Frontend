        ...
        <section className="section-2 w-screen">
          <div className='flex justify-between gap-1 ml-4 mr-4 h-auto'>
            ...
            <div className="article-blaze">
              <Link className="link" to="/products">MEN & WOMEN</Link>
             ...
             {/* About Section */}
             <div className='article-blaze'>
              <Link className="link" to="/fragrance">FRAGRANCE</Link>
        ...
        <div id="collections" className="">
          ...
          <div className="grid grid-cols-2">
            <div  className="relative">
              ...
              />
              <div onClick={RedirectWomen} className="grid-img absolute top-0 w-full text-center text-white text-2xl">Women's Collection</div>
            </div>
            <div  className="relative">
            <img 
              className="cols-image w-full h-full object-cover" 
              ...
              alt="" 
            />
            <div onClick={RedirectMen} className="grid-img absolute top-0 w-full text-center text-white text-2xl">Men's Collection</div>
            </div>
          </div>  
        </div>
      </div>
