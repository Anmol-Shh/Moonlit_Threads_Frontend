...
const Shop = () => {
  ...
  const MenvideoUrl = 'https://menscollection.s3.ap-south-1.amazonaws.com/MensMain.webm';
  return (
    <>
    <Header />
    ...
    <h3 className="mensHeader text-[40px] md:text-[100px] text-center">Men's Collection</h3>
    </div>
    ...
    <video className="w-full h-auto" autoPlay loop muted>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6">
        {products.map((product) => (
          <div
            key={product._id}
            className="cursor-pointer bg-[#f6f6f6] rounded-md"
